...
class BookFutureBuilder extends StatelessWidget {
  const BookFutureBuilder({
    Key? key,
                            ...
                            Align(
                              ...
                              child: ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl: books[index].thumbnailUrl != null
                                      ? books[index].thumbnailUrl!
                                      : 'https://cdn.vectorstock.com/i/1000x1000/57/47/i-am-sorry-funny-cartoon-comic-chicken-vector-18285747.webp',
                                  width: 75,
                                  height: 120,
                                  fit: BoxFit.cover,
